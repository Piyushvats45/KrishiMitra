    ...
    <div className="min-h-screen">
      ...
      <div className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">What is KrishiMitra?</h2>
          <p className="text-xl text-gray-600">
            KrishiMitra is an innovative platform designed to support farmers in making smarter agricultural decisions. 
            With personalized fertilizer recommendations, crop suggestions based on location, and awareness of government schemes, 
            KrishiMitra aims to create a positive impact on farming practices across the globe.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-green-50 p-8 rounded-2xl shadow-lg">
            ...
            <p className="text-gray-600">
              Using data from your location, KrishiMitra provides precise recommendations on the best fertilizers and crops suited 
          ...
          <div className="bg-blue-50 p-8 rounded-2xl shadow-lg">
            ...
            <p className="text-gray-600">
              KrishiMitra keeps you informed about the latest government schemes, grants, and subsidies available to farmers. 
          ...
          <div className="bg-yellow-50 p-8 rounded-2xl shadow-lg">
            ...
            <p className="text-gray-600">
              ...
              KrishiMitra provides tips and resources to help you improve productivity and protect your crops.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-100 py-16 px-4">
        <div className="max-w-7xl mx-auto text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            At KrishiMitra, our mission is to empower farmers with the knowledge and tools they need to make informed decisions. 
      ...
      <div className="py-16 px-4">
        <div className="max-w-7xl mx-auto text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">
            KrishiMitra is not just a platform, it's a community of forward-thinking farmers who are committed to improving agriculture. 
