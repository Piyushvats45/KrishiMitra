          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-600 text-sm">LNCT, Bhopal</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail size={18} className="text-green-600 flex-shrink-0" />
                <a href="mailto:piyushkrjha108@gmail.com" className="text-gray-600 hover:text-green-600 text-sm">
                  piyushkrjha108@gmail.com
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Phone size={18} className="text-green-600 flex-shrink-0" />
                <a href="tel:+919798025831" className="text-gray-600 hover:text-green-600 text-sm">
                  +91 9798025831
                </a>
              </li>
            </ul>
